...
# 🎯 FIX: Escaped shell variables using double dollar signs ($$) so Docker builds safely
...
# Keep single '$' here because $STREAMLIT_SECRETS_TOML is evaluated at container RUNTIME, not build time
