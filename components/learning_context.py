...
def render():
    ...
    saved_topic = st.session_state.get("active_topic", topics[0])
    ...
    if isinstance(topic_dict, dict):
        ...
        saved_subtopic = st.session_state.get("active_sub_topic", sub_topics[0])
    ...
    # Safely convert outcomes into a flat list of strings
    ...
    # LEARNING OUTCOME
    # -----------------------------
    saved_outcome = st.session_state.get("active_learning_outcome", outcomes[0])
